...
//        }
//        (*it)->draw(getPlayGround()->getTime());
//        if (type == GL_SELECT) {
//            glPopName();
//        }
//    }
    getPlayGround()->world->update(getPlayGround()->getTime());
    getPlayGround()->world->draw(getPlayGround()->getTime(),type);
    glPopMatrix();
}
...
//            }
            Object * obj = getPlayGround()->world->getDescendantByName(s);
            if (obj) {
                if (obj->isSelected()) {
...
//            }
            Object * obj = getPlayGround()->world->getDescendantByName(s);
            if (obj) {
                getPlayGround()->controller->setFollow(obj);
            }
            display();
        }
    }
...
void PlayGround::arrangeObjects() {
    ...
    trajectory_earth->setReference(sun);
    Earth * earth = new Earth();
    earth->setReference(sun);
    earth->setDebugState(PRINT_NAME);
    
    //earth->setDebugState(PRINT_POS);
